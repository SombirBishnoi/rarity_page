...
import dorimon from "../assets/img/png/dorimon.png";
function Rarity() {
  return (
    <>
      <div className="section back_clr line_0 py-5 overflow-hidden">
        <div className="container">
          <div>
            <h2 className="text-center Rarity ff_space  fw_700 fs_90">
              Rarity
            </h2>
            <span className="d-flex justify-content-between align-items-center flex-column flex-lg-row">
              <button
                ...
                className="btun2 py-1 ff_code fw_700 fs_28 my-2 my-lg-0 mx-0 mx-lg-2"
              >
                Background
              </button>
              <button
          ...
          <div className="row">
            <div
              data-aos="fade-down"
              data-aos-duration="3000"
              className="col-lg-3 col-sm-4 col-6 p-3"
            >
